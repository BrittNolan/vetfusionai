  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-pine-deep">
      ...
      <div className="relative mx-auto max-w-4xl px-5 py-24 text-center sm:px-8 sm:py-28 lg:py-32">
        ...
        <h2 className="reveal mx-auto mt-6 font-display text-4xl font-medium tracking-tight text-balance text-paper sm:text-5xl">
          Set up a care system your team can{" "}
          <em className="text-copper-soft italic">actually use</em>.
        </h2>
        <p className="reveal mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-paper/75">
        ...
        <ContactForm />
        <p className="reveal mt-8 font-mono text-[0.78rem] tracking-wide text-paper/75">
